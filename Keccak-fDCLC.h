...
private:
    /*
     *For differential cryptanalysis, the initialization function compute a table for all input difference patterns with all their compatible output differences and propagation weights added to.
     */
    void initializeAll();
    /**
      *
