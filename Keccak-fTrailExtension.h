...
public:
    /** The constructor instantiates an object of the class.
     * It first initializes the different attributes of a keccak-f instance referenced by aParent with KeccakPropagation()constructors.
     * Then it specifies the bounds on the weight and trails according to the attributs it sets previously.
     See KeccakFPropagation::KeccakFPropagation(). */
    ...
    void forwardExtendTrail(const Trail& trail, TrailFetcher& trailsOut, unsigned int nrRounds, int maxTotalWeight, bool testCollision[32][2]);
    ...
    void forwardExtendTrails(TrailIterator& trailsIn, TrailFetcher& trailsOut, unsigned int nrRounds, int maxTotalWeight, bool testCollision[32][2]);
    /** Starting from a given trail (prefix or core), this method 
    ...
    void backwardExtendTrail(const Trail& trail, TrailFetcher& trailsOut, unsigned int nrRounds, int maxTotalWeight, int constrs);
	...
	void backwardExtendTrails(TrailIterator& trailsIn, TrailFetcher& trailsOut, unsigned int nrRounds, int maxTotalWeight, int constrs);
protected:
    void recurseForwardExtendTrail(const Trail& trail, TrailFetcher& trailsOut, unsigned int nrRounds, int maxTotalWeight);
    void recurseForwardExtendTrail(const Trail& trail, TrailFetcher& trailsOut, unsigned int nrRounds, int maxTotalWeight, bool testCollision[32][2]);
    ...
    void recurseBackwardExtendTrail(const Trail& trail, TrailFetcher& trailsOut, unsigned int nrRounds, int maxTotalWeight, int constrs, bool allPrefixes);
